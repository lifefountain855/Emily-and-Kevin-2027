  ...
  return (
    <div className="animate-in fade-in duration-1000 pt-32 pb-24">
      <div className="container mx-auto px-4 max-w-3xl text-center">
        ...
        <br></br><br></br>
        {rsvpPassed==1 && <div><p className="text-4xl font-serif text-accent mb-12">RSVP has passed. Please contact us at kevinandemilysapp@gmail.com</p>
        ...
        {rsvpPassed==0 &&
        <div><p className="text-lg text-foreground/80 mb-2">
          Please let us know if you'll be celebrating with us by
        </p>
        <p className="text-2xl font-serif text-accent mb-12">November 15th</p></div>}
