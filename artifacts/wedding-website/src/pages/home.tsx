  ...
  return (
    <div className="grid grid-cols-4 gap-4 max-w-lg mx-auto mt-12 text-center">
      <div className="flex flex-col">
        <span className="text-4xl md:text-5xl font-serif text-primary">{timeLeft.days}</span>
        <span className="text-xs tracking-widest uppercase mt-2 text-muted-foreground">Days</span>
      </div>
      <div className="flex flex-col">
        <span className="text-4xl md:text-5xl font-serif text-primary">{timeLeft.hours}</span>
        <span className="text-xs tracking-widest uppercase mt-2 text-muted-foreground">Hours</span>
      </div>
      <div className="flex flex-col">
        <span className="text-4xl md:text-5xl font-serif text-primary">{timeLeft.minutes}</span>
        <span className="text-xs tracking-widest uppercase mt-2 text-muted-foreground">Mins</span>
      </div>
      <div className="flex flex-col">
        <span className="text-4xl md:text-5xl font-serif text-primary">{timeLeft.seconds}</span>
        <span className="text-xs tracking-widest uppercase mt-2 text-muted-foreground">Secs</span>
      </div>
    </div>
  );
}
