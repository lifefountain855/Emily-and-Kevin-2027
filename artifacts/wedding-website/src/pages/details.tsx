      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-24">
          <div className="bg-card p-8 border border-border shadow-sm">
            <h2 className="font-serif text-3xl text-accent mb-2">Ring Ceremony</h2>
            <p className="text-muted-foreground uppercase tracking-widest text-sm mb-6">3:00 PM</p>
            <div className="mb-6 space-y-2 text-foreground/80">
          ...
          <div className="bg-card p-8 border border-border shadow-sm">
            ...
            <p className="text-muted-foreground uppercase tracking-widest text-sm mb-6">5:30 PM - 10:30 PM</p>
            <div className="mb-6 space-y-2 text-foreground/80">
        ...
        {/* Timeline */}
        <div className="mb-24">
          <h2 className="font-serif text-4xl text-primary text-center mb-12">Weekend Timeline</h2>
          <div className="max-w-2xl mx-auto relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-border before:to-transparent">
            ...
            {[
              { time: "Friday, 6:00 PM", title: "Welcome Gathering", desc: "For out-of-town guests and family." },
              { time: "Saturday, 11:00 AM", title: "Sealing Ceremony", desc: "Private ceremony for immediate family." },
              { time: "Saturday, 3:00 PM", title: "Ring Ceremony", desc: "Open to all guests. Please arrive 15 minutes early." },
              { time: "Saturday, 5:30 PM", title: "Reception Begins", desc: "Light hors d'oeuvres and drinks." },
              { time: "Saturday, 6:30 PM", title: "Dinner Served", desc: "A formal sit-down dinner." },
              { time: "Saturday, 8:00 PM", title: "Dancing", desc: "Bring your dancing shoes!" },
            ].map((item, i) => (
              <div key={i} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active mb-8">
                ...
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 rounded border border-border bg-card shadow-sm">
                  <div className="flex flex-col mb-1">
                    <span className="font-serif text-xl text-primary">{item.title}</span>
                    <span className="text-sm tracking-wider uppercase text-muted-foreground mt-1">{item.time}</span>
                  </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="p-8 bg-[#7088a90d]">
            <h2 className="font-serif text-3xl mb-6 text-primary">Dress Code</h2>
          ...
          <div className="bg-primary/5 p-8">
            <h2 className="font-serif text-3xl text-primary mb-6">Travel & Stay</h2>
            <div className="space-y-6 text-foreground/80">
              <div>
                <h3 className="font-medium text-lg mb-1">Nearest Airport</h3>
                <p>Salt Lake City International (SLC) — 15 mins from downtown.</p>
              </div>
              <div>
                <h3 className="font-medium text-lg mb-1">Hotel Block</h3>
                <p>The Grand America Hotel</p>
                <a href="#" className="text-primary underline mt-1 inline-block">Book with our group rate</a>
              </div>
              <div>
                <h3 className="font-medium text-lg mb-1">Transportation</h3>
                <p>We recommend using rideshare (Uber/Lyft). Limited parking is available at both venues.</p>
              </div>
            </div>
          </div>
        </div>
