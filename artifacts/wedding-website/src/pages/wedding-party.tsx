export default function WeddingParty() {
  const maidOfHonor = { name: "Sarah Jenkins", role: "Maid of Honor", relation: "Sister of the Bride", bio: "Sarah has been Emily's partner in crime since day one." };
  const bestMan = { name: "Michael Sapp", role: "Best Man", relation: "Brother of the Groom", bio: "Kevin's older brother and lifelong role model." };
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mb-24">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 max-w-4xl mx-auto">
            {[maidOfHonor, bestMan].map((person, i) => (
              <div key={i} className="bg-card border border-border p-8 text-center shadow-md w-full sm:w-80">
                <img
                  src={i === 0 ? "/images/bridesmaid.png" : "/images/groomsman.png"}
                  alt={person.name}
                  className="w-56 h-56 rounded-full object-cover mx-auto mb-6 shadow"
                />
                <h3 className="font-serif text-3xl text-primary mb-1">{person.name}</h3>
